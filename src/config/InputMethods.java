...
public class InputMethods {
    ...
    public static int getIntegerQuantity() {
        while (true) {
    ...
    public static String getInputPassword() {
        while (true) {
            String result = getString();
            if (result.length() <= 5) {
                System.err.println("Please enter from 6 character.");
                continue;
            }
            ...
            if (!hasUppercase) {
                System.err.println("Please enter least 1 uppercase character.");
                continue;
            }
            return result;
        }
    }
    public static boolean isNumberWithCriteria(String input) {
    ...
    public static String getNumberWithCriteria() {
        while (true) {
            String number = getString();
            if (!isNumberWithCriteria(number)) {
                System.err.println("Invalid input. Please enter a 10-digit number starting with 0.");
                continue;
            }
            return number;
        }
